...
public class DashboardFragment extends Fragment implements SeekBar.OnSeekBarChangeListener, OnChartValueSelectedListener {
    ...
    protected String[] mParties = new String[]{
            "Assigned", "Closed", "Pending", "New", "Party E", "Party F", "Party G", "Party H",
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View myInflatedView = inflater.inflate(R.layout.fragment_dashboard, container, false);
        mChart = (BarChart) myInflatedView.findViewById(R.id.Piebarchart1);
...
//        yr.setInverted(true);
        ...
        pChart = (PieChart) myInflatedView.findViewById(R.id.chart1);
    ...
    private void setBarData(int count, float range) {
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "Category Chart");
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("Status Chart\ndeveloped for FOS");
